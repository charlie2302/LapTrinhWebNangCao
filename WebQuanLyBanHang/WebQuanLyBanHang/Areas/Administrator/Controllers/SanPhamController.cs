...
namespace WebQuanLyBanHang.Areas.Administrator.Controllers
{
    public class SanPhamController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "MaSP,TenSP,MaLoaiSP,SoLuong,Gia,HinhAnh,MoTa")] SanPham sanPham)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MaSP,TenSP,MaLoaiSP,SoLuong,Gia,HinhAnh,MoTa")] SanPham sanPham)
        {
            if (ModelState.IsValid)
            {
