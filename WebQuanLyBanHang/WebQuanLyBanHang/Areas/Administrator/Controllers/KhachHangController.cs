...
namespace WebQuanLyBanHang.Areas.Administrator.Controllers
{
    public class KhachHangController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "MaKH,HoTen,SDT,DiaChi,Gmail")] KhachHang khachHang)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MaKH,HoTen,SDT,DiaChi,Gmail")] KhachHang khachHang)
        {
            if (ModelState.IsValid)
            {
