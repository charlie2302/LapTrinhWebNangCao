...
namespace WebQuanLyBanHang.Areas.Administrator.Controllers
{
    public class NhanVienController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "MaNV,HoTen,CMND,SDT,DiaChi")] NhanVien nhanVien)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MaNV,HoTen,CMND,SDT,DiaChi")] NhanVien nhanVien)
        {
            if (ModelState.IsValid)
            {
